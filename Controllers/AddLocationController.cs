...
namespace ASPNETAOP.Controllers
{
    public class AddLocationController : Controller
    {
        ...
        [HttpPost]
        public IActionResult NewLocation(AddLocation loc, AddRadar? radar)
        {
            ViewData["Message"] = radar + "********************************" + " Error";
            ...
            using (SqlConnection connection = new SqlConnection(@"Server=localhost;Database=RADAR;Trusted_Connection=True;MultipleActiveResultSets=true"))
            {
                ...
                try
                {
                    ...
                    command.Parameters.AddWithValue("@name", radar.name);
                    command.Parameters.AddWithValue("@system", radar.system);
                    command.Parameters.AddWithValue("@configuration", radar.configuration);
                    command.Parameters.AddWithValue("@receiver_id", receiver_id);
                    command.Parameters.AddWithValue("@receiver_id", transmitter_id);
                    ...
                    command.Parameters.AddWithValue("@ID", key);
                    command.Parameters.AddWithValue("@ID", loc.name);
